#define SET_WALLPARERER_COMMAND "gsettings set org.gnome.desktop.background picture-uri ~/.wallparers/pictures/wallpaper"
#define GET_NUM_OF_FILES_IN_THE_DIRECTORIES_COMMAND "ls -l | wc > ~/.wallparers/num_of_files"
